...
class CalendarTab:
    ...
    def create_ui(self):
        ...
        # Calendar Container
        self.cal_container = ctk.CTkFrame(self.stats_frame, fg_color=theme.BG_CONTAINER, corner_radius=12)
        self.cal_container.pack(fill="both", expand=True, padx=5, pady=(0,10))

        # Month + Year Label (Inside the colored frame)
        ...
        self.grid_frame = ctk.CTkFrame(self.cal_container, fg_color="transparent")
        ...
        for row_idx, week in enumerate(cal, start=1):
            for col_idx, day in enumerate(week):
                ...
                if key in self.events and self.events[key]:
                    ...
                    fg_color = theme.ACCENT_BLUE  # text color
    ...
    def day_selected(self, day):
        ...
        # Makes it sure it appears at the top
